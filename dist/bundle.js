...
/******/ 	return __webpack_require__(__webpack_require__.s = "./build/snake_canvas.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n\nvar _BoardObject = _interopRequireDefault(__webpack_require__(/*! ./BoardObject */ \"./build/BoardObject.js\"));\n\nvar _ImageRepository = _interopRequireDefault(__webpack_require__(/*! ./ImageRepository */ \"./build/ImageRepository.js\"));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nlet Apple = Object.create(_BoardObject.default);\n\nApple.new = function (x, y) {\n  let newApple = Object.create(Apple);\n  newApple.init(x, y);\n  return newApple;\n};\n\nApple.draw = function (context, segmentSize) {\n  this.drawPicture(context, _ImageRepository.default.apple, segmentSize);\n};\n\nvar _default = Apple;\nexports.default = _default;\n\n//# sourceURL=webpack:///./build/Apple.js?");

/***/ }),

/***/ "./build/BoardObject.js":
/*!******************************!*\
  !*** ./build/BoardObject.js ***!
  \******************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n\nvar _BoardObject = _interopRequireDefault(__webpack_require__(/*! ./BoardObject */ \"./build/BoardObject.js\"));\n\nvar _ImageRepository = _interopRequireDefault(__webpack_require__(/*! ./ImageRepository */ \"./build/ImageRepository.js\"));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nlet SnakeSegment = Object.create(_BoardObject.default);\n\nSnakeSegment.new = function (x, y) {\n  let newSegment = Object.create(SnakeSegment);\n  newSegment.init(x, y);\n  return newSegment;\n};\n\nSnakeSegment.draw = function (context, segmentSize) {\n  this.drawPicture(context, _ImageRepository.default.snake_segment, segmentSize);\n};\n\nvar _default = SnakeSegment;\nexports.default = _default;\n\n//# sourceURL=webpack:///./build/SnakeSegment.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n\n__webpack_require__(/*! core-js/modules/web.dom.iterable */ \"./node_modules/core-js/modules/web.dom.iterable.js\");\n\nvar _snake_canvas = __webpack_require__(/*! ./snake_canvas */ \"./build/snake_canvas.js\");\n\nvar _utils = __webpack_require__(/*! ./utils */ \"./build/utils.js\");\n\nvar _Apple = _interopRequireDefault(__webpack_require__(/*! ./Apple */ \"./build/Apple.js\"));\n\nvar _SnakeSegment = _interopRequireDefault(__webpack_require__(/*! ./SnakeSegment */ \"./build/SnakeSegment.js\"));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nconst BOARD_FIELDS = {\n  EMPTY: 0,\n  SNAKE: 1,\n  APPLE: -1\n};\n\nfunction Board(size, context, segmentSize) {\n  this.size = size;\n  this.board = [];\n  this.direction = _snake_canvas.KEY_DIRECTIONS_CODES.RIGHT;\n  this.snake = [];\n  this.context = context;\n  this.segmentSize = segmentSize;\n  this.gameOver = false;\n  this.canChangeDirection = true;\n  this.applesCount = 0;\n\n  function initializeBoard(size) {\n    let board = [];\n\n    for (let i = 0; i < size; i++) {\n      let row = initializeArray(size);\n      board.push(row);\n    }\n\n    return board;\n  }\n\n  function initializeArray(size) {\n    let arr = [];\n\n    for (let i = 0; i < size; i++) {\n      arr.push(BOARD_FIELDS.EMPTY);\n    }\n\n    return arr;\n  }\n\n  this.initializeSnakePosition = function (snakeSize) {\n    for (let i = 0; i < snakeSize; i++) {\n      this.board[this.size - 1][i] = BOARD_FIELDS.SNAKE;\n\n      let newSegment = _SnakeSegment.default.new(i, this.size - 1);\n\n      this.snake.push(newSegment);\n      newSegment.draw(this.context, this.segmentSize);\n    }\n  };\n\n  this.init = function (snakeSize) {\n    this.board = initializeBoard(this.size);\n    this.initializeSnakePosition(snakeSize);\n    this.generateApple();\n  };\n\n  this.popSnakeTail = function () {\n    return this.snake.shift();\n  };\n\n  this.getSnakeHead = function () {\n    return this.snake[this.snake.length - 1];\n  };\n\n  this.displayBoard = function () {\n    this.board.forEach(row => {\n      console.log(row);\n    });\n  };\n\n  this.changeSnakeDirection = function (direction) {\n    if (this.canChangeDirection) {\n      switch (direction) {\n        case _snake_canvas.KEY_DIRECTIONS_CODES.LEFT:\n        case _snake_canvas.KEY_DIRECTIONS_CODES.RIGHT:\n          if (this.direction !== _snake_canvas.KEY_DIRECTIONS_CODES.RIGHT && this.direction !== _snake_canvas.KEY_DIRECTIONS_CODES.LEFT) {\n            this.direction = direction;\n          }\n\n          break;\n\n        case _snake_canvas.KEY_DIRECTIONS_CODES.UP:\n        case _snake_canvas.KEY_DIRECTIONS_CODES.DOWN:\n          if (this.direction !== _snake_canvas.KEY_DIRECTIONS_CODES.UP && this.direction !== _snake_canvas.KEY_DIRECTIONS_CODES.DOWN) {\n            this.direction = direction;\n          }\n\n          break;\n      }\n\n      this.canChangeDirection = false;\n    }\n  };\n\n  this.moveSnake = function () {\n    console.log(\"Apples: \", this.applesCount);\n    let head = this.getSnakeHead();\n    let newHead;\n\n    switch (this.direction) {\n      case _snake_canvas.KEY_DIRECTIONS_CODES.LEFT:\n        newHead = _SnakeSegment.default.new(head.x - 1, head.y);\n        break;\n\n      case _snake_canvas.KEY_DIRECTIONS_CODES.RIGHT:\n        newHead = _SnakeSegment.default.new(head.x + 1, head.y);\n        break;\n\n      case _snake_canvas.KEY_DIRECTIONS_CODES.UP:\n        newHead = _SnakeSegment.default.new(head.x, head.y - 1);\n        break;\n\n      case _snake_canvas.KEY_DIRECTIONS_CODES.DOWN:\n        newHead = _SnakeSegment.default.new(head.x, head.y + 1);\n        break;\n    }\n\n    if (!this.isGameOver(newHead)) {\n      if (this.board[newHead.y][newHead.x] === BOARD_FIELDS.APPLE) {\n        this.applesCount += 1;\n        this.generateApple();\n      } else {\n        let tail = this.popSnakeTail();\n        this.board[tail.y][tail.x] = BOARD_FIELDS.EMPTY;\n        tail.clear(this.context, this.segmentSize);\n      }\n\n      this.snake.push(newHead);\n      this.board[newHead.y][newHead.x] = BOARD_FIELDS.SNAKE;\n      newHead.draw(this.context, this.segmentSize);\n      this.canChangeDirection = true;\n    } else {\n      this.gameOver = true;\n    }\n  };\n\n  this.isGameOver = function (newHead) {\n    return !(this.board.length > newHead.y && newHead.y >= 0 && this.board[newHead.y].length > newHead.x && newHead.x >= 0 && this.board[newHead.y][newHead.x] !== BOARD_FIELDS.SNAKE);\n  };\n\n  this.generateApple = function () {\n    let appleFound = false;\n\n    while (!appleFound) {\n      let x = (0, _utils.getRandomIntFromRange)(0, this.board.length - 1);\n      let y = (0, _utils.getRandomIntFromRange)(0, this.board.length - 1);\n\n      if (this.board[y][x] === BOARD_FIELDS.EMPTY) {\n        appleFound = true;\n        this.board[y][x] = BOARD_FIELDS.APPLE;\n\n        let apple = _Apple.default.new(x, y);\n\n        apple.draw(this.context, this.segmentSize);\n      }\n    }\n  };\n}\n\nvar _default = Board;\nexports.default = _default;\n\n//# sourceURL=webpack:///./build/board.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.KEY_DIRECTIONS_CODES = void 0;\n\n__webpack_require__(/*! core-js/modules/web.dom.iterable */ \"./node_modules/core-js/modules/web.dom.iterable.js\");\n\nvar _obstacles = _interopRequireDefault(__webpack_require__(/*! ./obstacles.js */ \"./build/obstacles.js\"));\n\nvar _snake = _interopRequireDefault(__webpack_require__(/*! ./snake.js */ \"./build/snake.js\"));\n\nvar _board = _interopRequireDefault(__webpack_require__(/*! ./board */ \"./build/board.js\"));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nconst KEY_DIRECTIONS_CODES = {\n  LEFT: 37,\n  RIGHT: 39,\n  UP: 38,\n  DOWN: 40\n};\nexports.KEY_DIRECTIONS_CODES = KEY_DIRECTIONS_CODES;\n\nwindow.onload = function () {\n  let canvas;\n  let context;\n  let speed = 10;\n  let board;\n  canvas = document.getElementById(\"mainGameCanvas\");\n  context = canvas.getContext(\"2d\");\n  board = new _board.default(10, context, 50);\n  board.init(3);\n  document.addEventListener('keydown', function (e) {\n    let keyCode = e.keyCode;\n\n    if (Object.values(KEY_DIRECTIONS_CODES).includes(keyCode)) {\n      e.preventDefault();\n      board.changeSnakeDirection(keyCode);\n    } else if (keyCode == 32 && board.gameOver) {\n      context.clearRect(0, 0, canvas.width, canvas.height);\n      board = new _board.default(10, context, 50);\n      board.init(3);\n      render();\n    }\n  });\n\n  function render() {\n    let runGame = setInterval(() => {\n      if (!board.gameOver) {\n        board.moveSnake();\n      } else {\n        console.log(\"Game over\");\n        clearInterval(runGame);\n      }\n    }, 20 * speed);\n  }\n\n  render();\n};\n\n//# sourceURL=webpack:///./build/snake_canvas.js?");
